                    ...
                    <div class="w-full flex-1">
                        ...
                        <div class="mx-auto max-w-xs">
                            ...
                            <p class="mt-6 text-xs text-gray-600 text-center">
                                <a href="forget_pass.php" style="font-weight: bold; text-decoration:underline"> Şifrəni unutmusan?</a>
                            </p>
                            <p class="mt-6 text-xs text-gray-600 text-center">
                                Hesabın yoxdur?
                                <a href="registration.php" style="font-weight: bold;"> Qeydiyyatdan Keç</a>
                            </p>
                        </div>
                    </div>
                </div>
